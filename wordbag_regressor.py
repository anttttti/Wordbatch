...
class WordbagRegressor(object):
    def __init__(self, pickle_model="", datadir=None):
        self.wordbatch = wordbatch.WordBatch(normalize_text, extractors=[("wordbag", {"hash_ngrams":3,
          "hash_ngrams_weights":[-1.0, -1.0, 1.0],"hash_size":2**23, "norm":'l2', "tf":'binary', "idf":50.0})],
        # hash_polys=True, hash_polys_window=20, hash_polys_mindf=40, hash_polys_maxdf=0.3, hash_polys_weight=-2.0),
        procs=8)
        self.clf= Ridge(alpha=20.0, random_state=0)
